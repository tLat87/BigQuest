    ...
    <BackgroundImage>
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          {/* Character card with achievements */}
          <View style={styles.characterCard}>
            ...
            <Image source={require('../assets/img/3.png')} style={{width: 300, height: 300}}/>
          </View>

          {/* Text content */}
          <View style={styles.textContainer}>
            <Text style={styles.title}>
              For each level you will receive achievements.
            </Text>
            <Text style={styles.subtitle}>
              Let's start small - 10 fish, and then even bigger challenges await us!
            </Text>
          </View>
